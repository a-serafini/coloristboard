...
async function onRequestGet(context) {
  ...
  const zurichTimeStr = (/* @__PURE__ */ new Date()).toLocaleString("en-US", { timeZone: "Europe/Zurich" });
  ...
  cachedData.lastUpdate = (/* @__PURE__ */ new Date()).toISOString();
  const result = {
    ...cachedData,
    isOpen,
...
// ../.wrangler/tmp/pages-baHS7n/functionsRoutes-0.42114238966096373.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-ufT0WG/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-ufT0WG/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.8607177352669426.mjs.map
